...
import logging
import pickle ## need to learn. for Python data structure / data dump & restore.
import numpy as np
...
def simulation():
    ...
    java_cmd = [
        ...
        '-Dfile.encoding = UTF-8 @/var/folders/gg/1jfz30d15h309vq0rylkp93m0000gp/T/cp_695jk83987a0lwpa0nons41m6.argfile',
        'xpRobotBombSim.App'
    ]
...
def train():
    ...
    java_cmd = [
        '/Library/Java/JavaVirtualMachines/jdk-13.0.1.jdk/Contents/Home/bin/java',
        '-Dfile.encoding = UTF-8',
        '@/var/folders/gg/1jfz30d15h309vq0rylkp93m0000gp/T/cp_crn8f22jdov65ye0sncgoj7qv.argfile',
        'xpRobotBomb.App'
    ]
    ...
    pickle.dump(results[0], open('policy.pickle', 'wb')) ## state-action pairs
    pickle.dump(results[1], open('q.pickle', 'wb')) ## q values
    pickle.dump(results[2], open('G.pickle', 'wb')) ## all the rewards
    plot_G(25)
    return
